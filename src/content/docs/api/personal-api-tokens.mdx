...
<DocsApiTable
  ...
  rows={[
    ...
    { method: 'GET', path: '/api/upload/limits', scope: ['upload:file'], description: '读取当前账号的实际上传限额与允许类型' },
    { method: 'GET', path: '/api/users/me/latest-updates', scope: ['resource:read:feed', 'post:read:feed', 'player:read:feed', 'video:read:feed'], description: '读取全站最近更新的公开内容与最近互动' },
    { method: 'GET', path: '/api/users/me/activity', scope: ['resource:read:activity', 'post:read:activity', 'player:read:activity', 'video:read:activity'], description: '读取自己内容的互动摘要' },
    { method: 'GET', path: '/api/users/{id}/featured', scope: ['resource:read:self'], description: '读取指定用户的精选内容与精选位上限' },
...
<DocsEndpoint method="GET" path="/api/users/me/latest-updates" scope="resource:read:feed + post:read:feed + player:read:feed + video:read:feed" />
...
<DocsEndpoint method="GET" path="/api/users/me/activity" scope="resource:read:activity + post:read:activity + player:read:activity + video:read:activity" />
...
<DocsEndpoint method="GET" path="/api/users/{id}/featured" scope="resource:read:self" />
