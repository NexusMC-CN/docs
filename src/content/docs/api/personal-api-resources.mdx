...
<DocsApiTable
  ...
  { method: 'GET', path: '/api/resources/{id}/edit/dependencies', auth: 'resource:read:self', description: '读取资源的依赖数据' },
  { method: 'GET', path: '/api/resources/{id}/edit/relations', auth: 'resource:read:self', description: '读取资源的关联关系' },
  { method: 'GET', path: '/api/resources/{id}/edit/tutorials', auth: 'resource:read:self', description: '读取资源关联的教程帖' },
  { method: 'GET', path: '/api/resources/{id}/edit/documentation', auth: 'resource:read:self', description: '读取资源关联的文档帖' },
  { method: 'GET', path: '/api/resources/{id}/edit/permissions', auth: 'resource:read:self', description: '读取当前用户对资源的编辑权限' },
  ...
  { method: 'PUT', path: '/api/resources/{id}/archive', auth: 'resource:update:self', description: '归档或取消归档自己的资源' },
...
<DocsEndpoint method="PUT" path="/api/resources/{id}/archive" scope="resource:update:self" contentType="application/json" />
